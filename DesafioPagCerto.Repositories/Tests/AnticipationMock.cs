...
namespace DesafioPagCerto.Repository.Tests
{
    public class AnticipationMock : IAnticipationRepository
    {
        ...
        public IEnumerable<Anticipation> ListAll(StatusAnticipations? status)
        {
            ...
            {
                new Anticipation(
                    new Guid(), DateTime.Now, DateTime.Now, DateTime.Now, null, _statusAnticipations,
                    1000, 0,
                    new[]
                    {
                        new Transaction(
                ...
                new Anticipation(
                    new Guid(), DateTime.Now, DateTime.Now, DateTime.Now, null, StatusAnticipations.Finish,
                    1000, 0,
                    new[]
                    {
                        new Transaction(
                ...
                new Anticipation(
                    new Guid(), DateTime.Now, DateTime.Now, DateTime.Now, null, StatusAnticipations.InAnalysis,
                    1000, 0,
                    new[]
                    {
                        new Transaction(
